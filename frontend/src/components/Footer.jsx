...
const Footer = () => {
  ...
  const socials = [
    ...
    { icon: 'fa-brands fa-whatsapp', href: 'https://wa.me/911111111111', label: 'WhatsApp' },
  ];
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm text-white leading-snug">Gurugram</p>
                  <p className="text-xs text-gray-500 mt-0.5">Haryana – 122001</p>
                  <p className="text-xs text-gray-500 mt-1">Indore | Ahmedabad | Jaipur</p>
                </div>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+911111111111" className="text-sm text-white hover:text-[#c5a059] transition duration-200">
                  +91 1111111111
                </a>
              </li>
              <li className="flex items-center gap-3">
