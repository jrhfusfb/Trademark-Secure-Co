        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto animate-fadeInUp">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <a href="https://wa.me/911111111111" target="_blank" rel="noopener noreferrer" className="bg-white/5 hover:bg-white/10 backdrop-blur-md border border-white/20 text-white px-8 py-4 rounded-full font-bold text-lg transition duration-300 hover:scale-105 active:scale-95 flex items-center justify-center gap-2">
              ...
              <div className="space-y-6 perspective-1000">
                ...
                <div className="bg-gray-50 border border-gray-100 p-4 sm:p-6 rounded-2xl flex items-center gap-3 sm:gap-4 card-3d shadow-sm overflow-hidden">
                  ...
                  <div className="min-w-0">
                    ...
                    <a href="https://wa.me/911111111111" target="_blank" rel="noopener noreferrer" className="text-lg sm:text-xl font-bold text-primary hover:text-green-600 transition duration-300 break-words">+91 1111111111</a>
                  </div>
                </div>
                {/* Email */}
                <div className="bg-gray-50 border border-gray-100 p-4 sm:p-6 rounded-2xl flex items-center gap-3 sm:gap-4 card-3d shadow-sm overflow-hidden">
