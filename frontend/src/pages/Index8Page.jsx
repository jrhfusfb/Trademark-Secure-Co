  ...
  return (
    <div className="bg-gray-50 text-gray-800 antialiased selection:bg-secondary selection:text-white overflow-x-hidden w-full" id="top">
      ...
      <section id="services" className="py-20 bg-gray-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">Expert Trademark Services</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto mb-8 perspective-1000">
            ...
            <div className="bg-white rounded-3xl p-8 border border-gray-200/60 shadow-sm card-3d relative overflow-hidden group">
              <div className="absolute top-0 right-0 p-6 opacity-5 group-hover:opacity-10 transition-opacity">
                <i className="fa-solid fa-certificate text-9xl text-primary"></i>
              </div>
              ...
              <h3 className="text-2xl font-bold text-primary mb-3">Registration & Renewal</h3>
              <p className="text-gray-600 mb-6">Flawless trademark filing and timely renewals to secure your exclusive rights.</p>
            </div>

            {/* Assignment & Licensing */}
            <div className="bg-white rounded-3xl p-8 border border-gray-200/60 shadow-sm card-3d relative overflow-hidden group">
              <div className="absolute top-0 right-0 p-6 opacity-5 group-hover:opacity-10 transition-opacity">
                <i className="fa-solid fa-file-signature text-9xl text-primary"></i>
              </div>
              <div className="w-14 h-14 bg-primary rounded-2xl flex items-center justify-center mb-6">
                <i className="fa-solid fa-handshake text-secondary text-2xl"></i>
              </div>
              <h3 className="text-2xl font-bold text-primary mb-3">Assignment & Licensing</h3>
              <p className="text-gray-600 mb-6">Legally binding agreements to safely monetize and transfer your IP assets.</p>
            </div>

            {/* Objections & Hearings */}
            <div className="bg-white rounded-3xl p-8 border border-gray-200/60 shadow-sm card-3d relative overflow-hidden group">
              <div className="absolute top-0 right-0 p-6 opacity-5 group-hover:opacity-10 transition-opacity">
                <i className="fa-solid fa-scale-balanced text-9xl text-primary"></i>
              </div>
              <div className="w-14 h-14 bg-primary rounded-2xl flex items-center justify-center mb-6">
                <i className="fa-solid fa-gavel text-secondary text-2xl"></i>
              </div>
              <h3 className="text-2xl font-bold text-primary mb-3">Objections & Hearings</h3>
              <p className="text-gray-600 mb-6">Aggressive legal defense and strategic replies to registry objections.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-primary text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 animate-fadeInUp">
          <div className="text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Transparent <span className="text-secondary">Flat-Rate</span> Pricing</h2>
            <p className="text-gray-300 max-w-2xl mx-auto">Choose your level of protection. No hidden costs. No hourly surprises.</p>
            <p className="mt-6 text-sm text-gray-400"><i className="fa-solid fa-shield-halved text-secondary mr-1"></i> End-to-End Lawyer Support Available.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">Comprehensive Trademark Solutions</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">From initial clearance to ongoing protection, our experienced attorneys handle every aspect of your brand's security.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto mb-8 perspective-1000">
            ...
            <div className="bg-white rounded-3xl p-8 border border-gray-200/60 shadow-sm card-3d relative overflow-hidden group">
              ...
              <h3 className="text-2xl font-bold text-primary mb-3">Registration & Renewal</h3>
              <p className="text-gray-600 mb-6">Secure your brand identity with flawless initial filing and maintain exclusive rights with timely, hassle-free renewals.</p>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 border border-gray-200/60 shadow-sm card-3d relative overflow-hidden group">
              ...
              <h3 className="text-2xl font-bold text-primary mb-3">Assignment & Licensing</h3>
              <p className="text-gray-600 mb-6">Monetize and transfer your IP assets securely. We draft robust agreements to protect your commercial interests.</p>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 border border-gray-200/60 shadow-sm card-3d relative overflow-hidden group">
              ...
              <h3 className="text-2xl font-bold text-primary mb-3">Objections & Hearings</h3>
              <p className="text-gray-600 mb-6">Strategic legal representation. We draft compelling replies to examination reports and fiercely defend your mark at hearings.</p>
            </div>
          </div>
        </div>
      </section>
